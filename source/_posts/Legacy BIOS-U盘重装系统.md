...
这是很久之前写的一篇精简版装机记录，当时是为老电脑换SSD，需要重新装机，并不一定适合所有机器；而且当时还没有骨骼清奇的UFEI启动，不过总体过程大致相同，准备工具-->PE清系统盘-->安装系统-->安装驱动-->安装软件。
...
- 制作U盘启动盘：下载微软官方提供的工具 Windows USB/DVD Download Tool ，一键制作U盘启动盘；

  <s>制作U盘启动盘：下载<u>U盘启动盘制作工具</u>【U大师】【老毛桃】等，一键制作U盘启动盘；</s>
